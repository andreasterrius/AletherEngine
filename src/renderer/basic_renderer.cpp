...
// void ale::BasicRenderer::prepare_shadowable_objects(
//     vector<Renderable> &renderables) {
//   SDFGeneratorGPU sdfgen;

//   // In this function, we will change 3d texture in 2d texture atlas
//   // The reason being, it's harder to batch 3d textures compared to 2d
//   textures. for (auto &renderable : renderables) {
...
//         sdfgen.add_mesh(renderable.model->path.filename().string() + "-" +
//                             to_string(i) + "-" + to_string(r),
...
//       unsigned int flat_index = x + (y * size2d.x * size2d.z) + (z *
//       size2d.x);
...
//       texture_atlas[i].texture.dump_data_to_file(
